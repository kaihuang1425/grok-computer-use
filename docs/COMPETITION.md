...
- Fara1.5: strong browser agent plus serious verifier/evaluation stack.
...
2. Cross-app checkpoint graph: persist artifacts and evidence between applications, not just screenshots/conversation memory.
3. Hybrid router with failure-aware escalation: API/shell/browser/UIA/vision/coordinates chosen by reliability and disruption, and switched after classified failure.
